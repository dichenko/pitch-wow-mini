# Spec: multilingual-tts

## Purpose

Shared speech layer contracts for multilingual TTS. Defines supported languages (`ru`, `uz`, `en`), normalization, provider adapters, factory routing by normalized language, transcript-language-based TTS selection, text sanitization, OGG/Opus conversion for Telegram compatibility, best-effort TTS with text fallback, and temp file cleanup.
